    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] p-6">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-display font-bold text-white tracking-tight uppercase">Enlist Sentinel</h1>
          <p className="text-slate-500 text-[10px] uppercase tracking-[0.2em] mt-2 font-semibold">Join the Imperial Network</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-2">Designation (Email)</label>
        ...
        <div className="mt-10 pt-8 border-t border-white/5 flex flex-col gap-4">
          <p className="text-center text-[10px] text-slate-500 uppercase tracking-widest">
            Already Enlisted? <Link to="/login" className="text-blue-400 font-bold hover:underline">Authenticate</Link>
          </p>
